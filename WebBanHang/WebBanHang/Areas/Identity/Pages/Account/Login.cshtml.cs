...
namespace WebBanHang.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        private readonly UserManager<User> _userManager; // Thêm UserManager để kiểm tra vai trò
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        // Nếu là Admin, chuyển hướng đến dashboard của Admin Area
                        return LocalRedirect("/Admin/Admin/Index");
                    }

                    // Nếu không phải Admin, chuyển hướng đến trang mặc định
